    ...
    <ThemedView margin>
      <ThemedCard>
        <SectionList
          ...
          ListHeaderComponent={ () => (
            <ThemedText type='h2' className='font-bold text-2xl mb-3'>Personajes</ThemedText>
          )}
          renderSectionHeader={ ({ section }) => (
            <ThemedText type='h2' className='font-semibold bg-light-background dark:bg-dark-background p-1 rounded'>{ section.title }</ThemedText>
          )}
          stickySectionHeadersEnabled
          ListFooterComponent={ () => (
            <ThemedText type='h2' className='font-semibold my-2'>Secciones: { houses.length }</ThemedText>
          )}
